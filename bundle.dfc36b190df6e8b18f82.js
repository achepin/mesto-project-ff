...
function createCard(cardData, userId, openImagePopup, handleLike, handleDelete) {
  ...
  cardLikeButton.addEventListener('click', function () {
    handleLike(cardData, cardLikeButton, function (updatedCard) {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  Promise.all([getUserInfo(), getCards()]).then(function (_ref) {
    ...
    cards.forEach(function (card) {
      var createdCard = createCard(card, userData._id, openImagePopup, handleLike, handleDelete);
  ...
  newCardForm.addEventListener("submit", function (evt) {
    ...
    addCard(name, link).then(function (card) {
      var newCard = createCard(card, userData._id, openImagePopup, handleLike, handleDelete);
